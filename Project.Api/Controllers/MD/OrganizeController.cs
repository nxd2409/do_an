...
namespace Project.Api.Controllers.MD
{
    ...
    [ApiController]
    public class OrganizeController(IOrganizeService service) : ControllerBase
    {
        public readonly IOrganizeService _service = service;

        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] OrganizeDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] OrganizeDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] OrganizeDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("UpdateOrder")]
        public async Task<IActionResult> UpdateOrder([FromBody] List<OrganizeDto> request)
        {
            var res = new TransferObject();
