...
namespace Project.Api.Controllers.MD
{
    ...
    {
        public readonly IRoomService _service = service;

        [HttpGet("Search")]
        public async Task<IActionResult> Search([FromQuery] RoomDto filter)
        {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] RoomDto request)
        {
            var res = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] RoomDto request)
        {
            var res = new TransferObject();
